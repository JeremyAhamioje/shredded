...
export const SKU_GROUP = {
  ...
  'nd-shredded-ls-set-blush': { group: 'shredded-long-sleeve-set', color: 'Blush' },

  // Flare Jumpsuit
  'nd-flare-jumpsuit-black': { group: 'flare-jumpsuit', color: 'Black' },
  'nd-flare-jumpsuit-red':   { group: 'flare-jumpsuit', color: 'Red' },
};
